...
class HotMoviesItemWidgetState extends State<HotMovieItemWidget> {
  // static const methodChannel = const MethodChannel('flutter.movie/buy');
              ...
              children: <Widget>[
                ...
                OutlineButton(
                  ...
                  onPressed: () {
                    ...
                    print('购买 ' + widget.hotMovieData.title + ' 电影票一张');
                  },
                )
              ],
            ),
